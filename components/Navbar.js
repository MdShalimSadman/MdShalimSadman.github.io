...
const Navbar = () => {
  ...
  return (
    <header className="text-gray-600 body-font ">
      <div className="px-8 container mx-auto flex flex-wrap  pb-5 flex-col md:flex-row items-center justify-between ">
        <a href={"/"} className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
          <Image src="/logo3.png" alt="" width={180} height={40} />
        </a>
        <nav className="md:ml-auto flex flex-wrap items-center text-base text-white justify-center hidden md:block">
